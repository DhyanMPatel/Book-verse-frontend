  ...
  useEffect(() => {
    if (isOpen && bookData) {
      ...
      const category = categories.find(
        (cat) => cat.categoryName === bookData.category
      );
      ...
      setExistingCoverImage(bookData.coverImage || null);
      setExistingFile(bookData.fileUrl || null);
      setCoverImagePreview(bookData.coverImage || null);
      setFileUrlPreview(bookData.fileUrl ? "Existing PDF file" : null);
    }
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // Only append coverImage if a new file is selected
        ...
        >
          ...
          <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-gray-900">Update Book</h2>
              <button
                onClick={onClose}
                          ...
                          {(fileUrlPreview || existingFile) && (
                            <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
                              ...
                              <span className="text-sm text-gray-700">
                                {fileUrlPreview || "Existing PDF file"}
                              </span>
                              <button
                                type="button"
