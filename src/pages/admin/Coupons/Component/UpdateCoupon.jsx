...
const UpdateCoupon = ({ isOpen, onClose, onSubmit, couponData }) => {
  ...
  useEffect(() => {
    if (couponData) {
      setFormData({
        ...
        categoryId: couponData.categoryId?._id || couponData.categoryId || "",
        usageLimit: couponData.usageLimit || "",
        validTillDate: couponData.validTillDate
          ? new Date(couponData.validTillDate).toISOString().split("T")[0]
          : "",
