        ...
        {!isAdmin && (
          <>
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-blue-50 rounded-xl p-3 group relative">
              ...
              <div className="bg-green-50 rounded-xl p-3 group relative">
            ...
            <div className="bg-purple-50 rounded-xl p-3 mb-6 group relative">
