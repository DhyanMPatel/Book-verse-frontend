...
//                         <button className="quick-view-btn text-xs px-2 py-1">
...
//                         <div className="discount-badge text-xs px-1 py-0.5">
...
//                       <div className="book-category-tag text-xs px-2 py-0.5 mb-1">{book.category}</div>



//                       <h4 className="book-title text-sm mb-1 line-clamp-1">{book.title}</h4>



//                       <p className="book-author text-xs text-gray-600 mb-2">by {book.author}</p>
...
//                         <span className="rating-text text-xs">(4.0)</span>
...
//                           <span className="current-price text-sm font-bold">₹{book.price}</span>
...
//                         className="add-to-cart-btn text-xs px-3 py-1.5"
