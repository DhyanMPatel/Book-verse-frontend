      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join thousands of satisfied readers who found their next favorite
              book with us
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                content:
                  "Amazing collection and fast delivery! Found exactly what I was looking for.",
                rating: 5,
              },
              {
                name: "Rahul Kumar",
                role: "Student",
                content:
                  "Great prices and excellent customer service. My go-to place for books!",
                rating: 5,
              },
              {
                name: "Anjali Patel",
                role: "Teacher",
                content:
                  "Wide variety of educational books. Perfect for my classroom library.",
                rating: 5,
              },
